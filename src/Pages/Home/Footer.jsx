  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo.svg" alt="BharathiMS" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/Bharathims29"
            ...
            <li>
              <a
                href="https://www.instagram.com/bharathi_ms_thala"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/bharathi-raja-ms-172a2a236"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
